...
category: components
slug: check-form
shortDescription: "Retro check-in overlay styled for ArcadeKit."
longDescription: "Built for game-inspired onboarding flows, this React Native check-in card animates between states and keeps your monetization stats playful."
hasImage: true
imageUrl: /img/products/Check Component.png
imageAlt: Check Form Component | ArcadeKit
hasComponentCode: true
tags: ['Calculator']
techStack: ['React Native', 'Expo', 'TypeScript', 'Tailwind']
examples: [{nameOfPage: 'ArcadeKit', urlToPage: 'https://arcadekit.dev', descriptionOfUsage: 'ArcadeKit drops the overlay after every quest completion to celebrate the player.', imgageSrcOfUsage: ''}]
...
metaDescription: "A React Native check-in interface crafted by ArcadeKit for gamified finance apps."
metaTitle: "Arcade Check Form Component"
license: MIT
---
...
Quest Calculator by ArcadeKit

<CodeBlock fileName="cli">

```bash
npx arcadekit@latest add CheckForm
```

</CodeBlock>

Revenue Calculator component by [ArcadeKit - button](https://ui.shadcn.com/docs/components/button)

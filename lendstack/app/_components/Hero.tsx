  ...
  <div className="relative z-10 mx-auto grid max-w-7xl grid-cols-1 items-center gap-16 md:grid-cols-2 md:gap-8">
    <div className="relative z-10 space-y-4 pb-12 md:pb-0">
      <span
        ...
        id="style-givNe"
      >
        Open-source arcade UI kits for React Native teams
        <span
      ...
      >
        <span>
          The &quot;<span className="amazon-logo-font">arcade</span>&quot; of
        </span>
      ...
      <p
        ...
        id="style-cIYEM"
      >
        Addicting, interactive, and scalable interface kits for{' '}
        ...
        {' '}& more. Build a game-inspired React Native product in under 20 minutes with live Expo previews.
      </p>
      <div
